...
urlpatterns = [
    ...
    path("admin-panel/companies/", views.companies, name="admin_companies"),
    path("admin-panel/companies/<str:company_id>/", views.company_detail, name="admin_company_detail"),
